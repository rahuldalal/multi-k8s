...
docker push rahulvdalal/multi-client:latest
docker push rahulvdalal/multi-server:latest
docker push rahulvdalal/multi-worker:latest
docker push rahulvdalal/multi-client:$SHA
docker push rahulvdalal/multi-server:$SHA
docker push rahulvdalal/multi-worker:$SHA
kubectl apply -f k8s
